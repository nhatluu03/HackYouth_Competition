...
<body>
    ...
    <main class="main">
        ...
        <div class="game">
            <div class="game__display">
                ...
                <!-- display game here -->
                <?php 
                    // include('./games/escape_room.html') 
                ?>

                <i class="fa-solid fa-question question-ic"></i>
            ...
            <div class="game__chat-box">
                ...
                <i class="fa-solid fa-caret-right minimize-chatbox-ic"></i>
                <i class="fa-solid fa-caret-left  expand-chatbox-ic" style="display: none"></i>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        // document.getElementsByClassName("game__chat-box__form").onsubmit = function() {
        //     document.getElementsByClassName("game__chat-box__form").preventDefault();
        // }
    </script>
    ...
    <script>
        document.querySelector('.minimize-chatbox-ic').onclick = function() {
            ...
            document.querySelector('.game__chat-box').style.padding = "0";
        ...
        document.querySelector('.expand-chatbox-ic').onclick = function() {
            document.querySelector('.game__chat-box').style.width = "21%";
            document.querySelector('.game__chat-box').style.transition = "0.2s";
            document.querySelector('.game__chat-box').style.padding = "18px 12px 22px";
            document.querySelector('.game__display').style.width = "79%";
            this.style.display = "none";
